...
Now, looking at `games_played`: ``r coef(back_aic)["games_played"]``, we can see that your skill rating also increases with the number of games you play. This makes sense because it is fair to assume that you improve as a player the more you play. Practice always helps!
